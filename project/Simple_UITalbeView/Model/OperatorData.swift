...
struct CreatingObservables {
    static let array = [
        ...
        Operator(name: "Start", type: .creating,
                 ...
                 functions: ["startWith(_ self: Observable<_>) -> (_...) -> Observable<_>"],
...
struct TransformingObservables {
    static let array = [
        Operator(name: "Buffer", type: .transforming,
                 images: DiagramImages(stream1: true, stream2: false, opreator: true, result: true),
                 swiftCompatible: true,
                 functions: ["buffer(timeSpan: RxTImeInterval, count: Int, scheduler: SchedulerType) -> Observable<[[T]]>"],
        ...
        Operator(name: "Scan", type: .transforming,
                 images: DiagramImages(stream1: true, stream2: false, opreator: true, result: true),
                 swiftCompatible: true,
                 functions: ["scan(_ seed: A accumulator: (A, [T]) throw"],
                 urlString: "scan.html"),
        Operator(name: "Window", type: .transforming,
                 images: DiagramImages(stream1: true, stream2: false, opreator: true, result: true),
                 swiftCompatible: true,
                 functions: ["window(timeSpan: RxTimeInterval, count: Int, scheduler: SchedulerType) -> Observable<Obervable<[T]>>"],
...
struct FilteringObservables {
    static let array = [
        Operator(name: "Debounce", type: .filtering,
                 images: DiagramImages(stream1: true, stream2: false, opreator: true, result: true),
                 swiftCompatible: true,
                 functions: ["debounce(_ dutTime: RxTimeInterval, scheduler: SchedulerType) -> Observable<[T]>"],
        ...
        Operator(name: "First(Single)", type: .filtering,
                 images: DiagramImages(stream1: true, stream2: false, opreator: true, result: true),
                 swiftCompatible: true,
                 functions: ["single(_ sampler: ObservableType) -> Observable<[T]>", "single(_ predicate:)"],
                 urlString: "first.html"),
        Operator(name: "IgnoreElements", type: .filtering,
                 images: nil,
                 swiftCompatible: false,
                 functions: ["ignoreElements"], // todo:
        ...
        Operator(name: "Skip", type: .filtering,
                 images: DiagramImages(stream1: true, stream2: false, opreator: true, result: true),
                 swiftCompatible: true,
                 functions: ["skip(_ count:)", "skip(untile:)", "skip(while:)", "skip(_: scheduler:)"],
                 urlString: "skip.html"),
...
struct ErrorHandlingOperators {
    static let array = [
        Operator(name: "Catch", type: .errorHandling,
                 images: DiagramImages(stream1: true, stream2: false, opreator: true, result: true),
                 swiftCompatible: true,
                 functions: ["catch(_ self: Observable<_>)", "catch(sequence:)", "catchAndReturn(_ self:)"],
...
struct ConnectableOperators {
    static let array = [
        ...
        Operator(name: "RefCount", type: .connectable,
                 images: DiagramImages(stream1: true, stream2: false, opreator: true, result: true),
                 swiftCompatible: false, // trueになってたけどない？
                 functions: nil,
                 urlString: "refcount.html"),
        Operator(name: "Replay", type: .connectable,
                 images: DiagramImages(stream1: true, stream2: false, opreator: true, result: true),
                 swiftCompatible: true,
                 functions: ["toArray() -> Single([T])"],
